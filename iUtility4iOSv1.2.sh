...
echo " "
echo "[*] Reinstall Cydia"
echo "Rebooting Is Required After Running Script"
echo "Use yalu102 To Install Cydia"
elif [ "$a" = "0" ]
then
echo "Current NVRAM"
nvram -p
...
cd /var/mobile
echo "Code Executed.."
echo "For Cydia To Be Installed.."
echo "-Reboot iDevice"
echo "-Jailbreak With Yalu102"
...
echo "Okay"
echo "Have-Fun With Cydia!"
echo "Make Sure To Reboot Afterwards"
#
fi
fi